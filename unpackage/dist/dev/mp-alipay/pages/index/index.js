...
/***/ 58:
/*!***********************************************************!*\
  !*** E:/y/lanya/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \***********************************************************/
...
/***/ 59:
/*!****************************************!*\
  !*** E:/y/lanya/pages/index/index.vue ***!
  \****************************************/
/*! no static exports found */
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_57280228_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&id=57280228&scoped=true&lang=css& */ 68);
...
/***/ 60:
/*!***********************************************************************************!*\
  !*** E:/y/lanya/pages/index/index.vue?vue&type=template&id=57280228&scoped=true& ***!
  \***********************************************************************************/
...
/***/ 61:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/y/lanya/pages/index/index.vue?vue&type=template&id=57280228&scoped=true& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 62:
/*!*****************************************************************!*\
  !*** E:/y/lanya/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 63:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/y/lanya/pages/index/index.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _qqmapWxJssdk = _interopRequireDefault(__webpack_require__(/*! ../../utils/qqmap-wx-jssdk.js */ 64));
//
//
//
//
...
var _default = {
  ...
  data: function data() {
    return {
      ...
      characteristics: [],
      characteristicId: '',
      lanya: __webpack_require__(/*! ../../static/img/lanya.jpg */ 65),
      getLocation: __webpack_require__(/*! ../../static/img/getLocation.png */ 66),
      wmd: __webpack_require__(/*! ../../static/img/wmd.png */ 67),
      getUserInfo: {},
  ...
  onShow: function onShow() {
    ...
    if (this.openLanYa) {
      this.timer = setInterval(function () {
        _this2.handleOpenBluetoothAdapter();
      }, 1000);
    }
  ...
  methods: {
    // 支付宝登录授权认证
    userAlipayLoginCode: function userAlipayLoginCode() {
      var that = this;
      wx.login({
    ...
    alipayLogin: function alipayLogin(code) {
      ...
      uni.request({
        ...
        success: function success(res) {
          ...
          _this3.getUserInfo = JSON.parse(uni.getStorageSync('usersInfo'));
          console.log('缓存数据--2----', _this3.getUserInfo.data.userinfo);
          if (_this3.getUserInfo.data && _this3.getUserInfo.data.userinfo) {
            console.log('缓存数据--2----', _this3.getUserInfo.data.userinfo);
            _this3.getUserInfoDataToken = _this3.getUserInfo.data.userinfo ? true : false;
          }
        }
      });
    },
    ...
    // 999999999
    handleLanya: function handleLanya() {
      var that = this;
      var QQMapWX = __webpack_require__(/*! ../../utils/qqmap-wx-jssdk.js */ 64);
        ...
        complete: function complete() {
          ...
          qqmapsdk.reverseGeocoder({
            ...
            success: function success(res) {
              ...
              that.address_component = res.result.address_component;
    ...
    getawardDetail: function getawardDetail(code) {
      var _this6 = this;
              ...
              case 0:
                ...
                return uni.request({
                  ...
                  success: function success(res) {
                    var data = res.data;
                    uni.setStorageSync('usersInfo', JSON.stringify(data));
                    _this6.getUserInfo = JSON.parse(uni.getStorageSync('usersInfo'));
                    console.log('缓存数据--2----', _this6.getUserInfo.data.userinfo);
                    if (_this6.getUserInfo.data && _this6.getUserInfo.data.userinfo) {
                      console.log('缓存数据--2----', _this6.getUserInfo.data.userinfo);
                      _this6.getUserInfoDataToken = _this6.getUserInfo.data.userinfo ? true : false;
                    }
                  }
                });
              case 3:
    ...
    // 手动连接蓝牙
    handleOpenBluetoothAdapter: function handleOpenBluetoothAdapter() {
      var _this7 = this;
      if (this.openLanYa) {
        uni.showLoading({
          title: '请打开手机蓝牙'
        ...
        success: function success(res) {
          ...
          uni.getBluetoothAdapterState({
            ...
            success: function success(res1) {
              _this7.openLanYa = false;
              clearInterval(_this7.timer);
              console.log(res1, '本机设备的蓝牙已打开');
              uni.hideLoading();
              // 开始搜索蓝牙设备
              _this7.startBluetoothDeviceDiscovery();
            },
            fail: function fail(error) {
              uni.showToast({
                icon: 'none',
    ...
    onBluetoothDeviceFound: function onBluetoothDeviceFound() {
      ...
      uni.onBluetoothDeviceFound(function (res) {
        if (_this9.list.indexOf(res.devices[0].deviceId) == -1) {
          if (res.devices[0].name.slice(0, 4) === 'WMD8') {
            _this9.createBLEConnection(res.devices[0].deviceId);
            _this9.list.push({
    ...
    //选择设备连接吧deviceId传进来
    createBLEConnection: function createBLEConnection(deviceId) {
      var _this = this;
    ...
    getBLEDeviceCharacteristics: function getBLEDeviceCharacteristics() {
      ...
      setTimeout(function () {
        uni.getBLEDeviceCharacteristics({
          // 这里的 deviceId 需要已经通过 createBLEConnection 与对应设备建立链接
          deviceId: _this11.deviceId,
          // 这里的 serviceId 需要在 getBLEDeviceServices 接口中获取
          serviceId: _this11.serviceId,
          success: function success(res) {
            console.log('特征getBLEDeviceCharacteristics', res);
            _this11.characteristics = res.characteristics;
            console.log('特征数组', _this11.characteristics);
          ...
          success: function success(res) {
            ...
            res.services.forEach(function (item) {
              if (item.uuid.indexOf("FFE0") != -1) {
                _this12.serviceId = item.uuid;
                console.log("1800特征值", _this12.serviceId);
                //获取特征
                _this12.getBLEDeviceCharacteristics();
              }
            });
          }
        });
    ...
    handleInToPay: function handleInToPay() {
      var params = {
        deviceId: this.deviceId,
        serviceId: this.serviceId,
    ...
    //写入蓝牙 这页面传入PCSS是唤醒功能
    writeBLECharacteristicValue: function writeBLECharacteristicValue(v) {
      var _this13 = this;
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
        var unids, msg, buffer, dataView, i, resHex, buffers;
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                console.log('这页面传入PCSS是唤醒功能', v);
                console.log('这页面传入PCSS是唤醒功能1', _this13.deviceId);
                console.log('这页面传入PCSS是唤醒功能2', _this13.serviceId);
                console.log('这页面传入PCSS是唤醒功能3', _this13.characteristicId);
                unids = _this13.list[0].name.slice(4); //PASS PBSS
                msg = v + unids;
                ...
                resHex = _this13.ab2hex(buffer) + "0D0A";
                buffers = new Uint8Array(resHex.match(/[\da-f]{2}/gi).map(function (h) {
                  return parseInt(h, 16);
                })).buffer;
                console.log('这页面传入PCSS是唤醒功能3buffers', buffers);
                uni.writeBLECharacteristicValue({
                  deviceId: _this13.deviceId,
                  serviceId: _this13.serviceId,
                  characteristicId: _this13.characteristicId,
                  value: buffers,
                  success: function success(res) {
    ...
    listenValueChange: function listenValueChange() {
      ...
      uni.onBLECharacteristicValueChange(function (res) {
        ...
        var resHex = _this.ab2hex(res.value);
        console.log(resHex);

        // 最后将16进制转换为ascii码，就能看到对应的结果
        var result = _this.hexCharCodeToStr(resHex);
    ...
    // 创建订单
    createorder: function createorder(v, numV) {
      var _this = this;
...
/***/ 68:
/*!*************************************************************************************************!*\
  !*** E:/y/lanya/pages/index/index.vue?vue&type=style&index=0&id=57280228&scoped=true&lang=css& ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 69:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/y/lanya/pages/index/index.vue?vue&type=style&index=0&id=57280228&scoped=true&lang=css& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
