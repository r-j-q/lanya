...
try {
  components = {
    uPopup: function () {
      return __webpack_require__.e(/*! import() | uview-ui/components/u-popup/u-popup */ "uview-ui/components/u-popup/u-popup").then(__webpack_require__.bind(null, /*! @/uview-ui/components/u-popup/u-popup.vue */ 83))
    },
  }
} catch (e) {
  if (
...
var _qqmapWxJssdk = _interopRequireDefault(__webpack_require__(/*! ../../utils/qqmap-wx-jssdk.js */ 68));
//
//
//
//
...
var _default = {
  ...
  data: function data() {
    return {
      ...
      characteristics: [],
      characteristicId: '',
      lanya: __webpack_require__(/*! ../../static/img/lanya.jpg */ 69),
      getLocation: __webpack_require__(/*! ../../static/img/getLocation.png */ 70),
      wmd: __webpack_require__(/*! ../../static/img/wmd.png */ 71),
      getUserInfo: {},
  ...
  methods: {
    ...
    handleLanya: function handleLanya() {
      var that = this;
      var QQMapWX = __webpack_require__(/*! ../../utils/qqmap-wx-jssdk.js */ 68);
              ...
              case 0:
                ...
                return uni.request({
                  ...
                  success: function success(res) {
                    ...
                    _this5.getUserInfo = JSON.parse(uni.getStorageSync('usersInfo'));
                    console.log('缓存数据--2----', _this5.getUserInfo.data.userinfo);
                    if (_this5.getUserInfo.data && _this5.getUserInfo.data.userinfo) {
                      console.log('缓存数据--2----', _this5.getUserInfo.data.userinfo);
                      _this5.getUserInfoDataToken = _this5.getUserInfo.data.userinfo ? true : false;
                    }
                  }
                });
              case 3:
        ...
        success: function success(res) {
          ...
          uni.getBluetoothAdapterState({
            ...
            success: function success(res1) {
              _this6.openLanYa = false;
              clearInterval(_this6.timer);
              console.log(res1, '本机设备的蓝牙已打开');
              uni.hideLoading();
              // 开始搜索蓝牙设备
              _this6.startBluetoothDeviceDiscovery();
            },
            fail: function fail(error) {
              uni.showToast({
                icon: 'none',
    ...
    onBluetoothDeviceFound: function onBluetoothDeviceFound() {
      ...
      uni.onBluetoothDeviceFound(function (res) {
        if (_this8.list.indexOf(res.devices[0].deviceId) == -1) {
          if (res.devices[0].name.slice(0, 4) === 'WMD8') {
            _this8.createBLEConnection(res.devices[0].deviceId);
            _this8.list.push({
    ...
    getBLEDeviceCharacteristics: function getBLEDeviceCharacteristics() {
      ...
      setTimeout(function () {
        uni.getBLEDeviceCharacteristics({
          ...
          serviceId: _this10.serviceId,
          success: function success(res) {
            console.log('特征getBLEDeviceCharacteristics', res);
            _this10.characteristics = res.characteristics;
            console.log('特征数组', _this10.characteristics);
          ...
          success: function success(res) {
            ...
            res.services.forEach(function (item) {
              if (item.uuid.indexOf("FFE0") != -1) {
                _this11.serviceId = item.uuid;
                console.log("1800特征值", _this11.serviceId);
                //获取特征
                _this11.getBLEDeviceCharacteristics();
              }
            });
          }
        });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                console.log('这页面传入PCSS是唤醒功能1', _this12.deviceId);
                console.log('这页面传入PCSS是唤醒功能2', _this12.serviceId);
                console.log('这页面传入PCSS是唤醒功能3', _this12.characteristicId);
                unids = _this12.list[0].name.slice(4); //PASS PBSS
                msg = v + unids;
                ...
                resHex = _this12.ab2hex(buffer) + "0D0A";
                ...
                uni.writeBLECharacteristicValue({
                  ...
                  serviceId: _this12.serviceId,
                  characteristicId: _this12.characteristicId,
                  value: buffers,
                  success: function success(res) {
